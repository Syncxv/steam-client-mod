    ...
    !function (P, D) {
      ...
      function H(e) {
        if (null !== e && "object" == typeof e)
          return (
            (e = Object.getPrototypeOf(e)) === Object.prototype || null === e
          );
      }
      function $(e, t, r) {
...
***************************************************************************** */ var ne =
      ...
      var d,
        ...
        Ee = function (e, t, r) {
          ...
          return "string" == typeof t ||
            (null !== e && "object" == typeof e && 1 === arguments.length)
            ? Se.apply(null, arguments)
            : (((n = "object" == typeof t ? t : {}).get = e),
      ...
      function kt(e, t) {
        return (
          null != e &&
          (void 0 !== t
            ? !1 !== R(e) && !!e[u].values.has(t) && ((t = N(e, t)), Ye(t))
            : Ye(e))
        );
      }
      function Rt(e) {
      ...
      function f(e, t) {
        ...
        return (
          ...
          !0 === e.isPromiseBasedObservable
            ? e
            : ((r = e = "function" == typeof e ? new Promise(e) : e),
              e.then(
              ...
              (r.case = p),
              (e = t && t.state === a ? t.value : void 0),
              Object(u.q)(r, { value: e, state: i }, {}, { deep: !1 }),
              r)
        );
      }
...
*/ var l = Object.getOwnPropertySymbols,
  ...
  R7aG: function (e, l, u) {
    ...
    !function (e) {
      ...
      function o(e) {
        return (
          !(!e || "object" != typeof e) &&
          (!(e = Object.getPrototypeOf(e)) || e === Object.prototype)
        );
      }
      function i(e) {
  ...
  Sj0R: function (P, e, t) {
    ...
    function ft(e) {
      SteamClient.WebChat.RegisterForFriendPostMessage(wt),
        ...
        R(),
        ct
          ? (k.SetLoadingState(E.FailRetry), N())
          : pt
          ? N()
          : ((O = setTimeout(ht, 4e3)),
            (A = setTimeout(dt, 1e3)),
    ...
    !function (global, Buffer) {
      var $jscomp = {
        ...
        COMPILED =
          ...
          ($jscomp.Map$isConformant = function () {
            ...
            try {
              var t,
                r,
                n = Object.seal({ x: 4 }),
                o = new e($jscomp.makeIterator([[n, "s"]]));
              return "s" != o.get(n) ||
                1 != o.size ||
                o.get({ x: 4 }) ||
                o.set({ x: 4 }, "t") != o ||
          ...
          ($jscomp.math.clz32 = function (e) {
            var t;
            return 0 === (e = Number(e) >>> 0)
              ? 32
              : ((t = 0) == (4294901760 & e) && ((e <<= 16), (t += 16)),
          ...
          ($jscomp.math.tanh = function (e) {
            ...
            return 0 === (e = Number(e))
              ? e
              : ((t = (1 - (t = Math.exp(-2 * Math.abs(e)))) / (1 + t)),
                e < 0 ? -t : t);
          }),
          ...
          ($jscomp.math.asinh = function (e) {
            ...
            return 0 === (e = Number(e))
              ? e
              : ((t = Math.log(Math.abs(e) + Math.sqrt(e * e + 1))),
                e < 0 ? -t : t);
          }),
          ...
          ($jscomp.math.trunc = function (e) {
            ...
            return (
              ...
              isNaN(e) || 1 / 0 === e || -1 / 0 === e || 0 === e
                ? e
                : ((t = Math.floor(Math.abs(e))), e < 0 ? -t : t)
            );
          }),
        ...
        jspb =
          ...
          (goog.loadFileSync_ = function (e) {
            var t;
            return goog.global.CLOSURE_LOAD_FILE_SYNC
              ? goog.global.CLOSURE_LOAD_FILE_SYNC(e)
              : ((t = new goog.global.XMLHttpRequest()).open("get", e, !1),
                t.send(),
                t.responseText);
          }),
          ...
          (goog.string.escapeChar = function (e) {
            var t, r;
            return e in goog.string.jsEscapeCache_
              ? goog.string.jsEscapeCache_[e]
              : e in goog.string.specialEscapeChars_
              ? (goog.string.jsEscapeCache_[e] =
                  goog.string.specialEscapeChars_[e])
              : (31 < (r = e.charCodeAt(0)) && r < 127
                  ? (t = e)
                  : (r < 256
                      ? ((t = "\\x"), (r < 16 || 256 < r) && (t += "0"))
                      : ((t = "\\u"), r < 4096 && (t += "0")),
      ...
      (jspb.Map.prototype.loadFromArray_ = function () {
        ...
        (goog.labs.userAgent.browser.getVersion = function () {
          ...
          var t,
            r,
            n = goog.labs.userAgent.util.getUserAgent();
          return goog.labs.userAgent.browser.isIE()
            ? goog.labs.userAgent.browser.getIEVersion_(n)
            : ((n = goog.labs.userAgent.util.extractVersionTuples(n)),
              (t = {}),
              goog.array.forEach(n, function (e) {
                t[e[0]] = e[1];
              }),
              (r = goog.partial(goog.object.containsKey, t)),
              goog.labs.userAgent.browser.isOpera()
                ? e(["Version", "Opera", "OPR"])
                : goog.labs.userAgent.browser.isEdge()
                ? e(["Edge"])
        ...
        (goog.userAgent.determineVersion_ = function () {
          var e, t;
          return goog.userAgent.OPERA && goog.global.opera
            ? goog.userAgent.operaVersion_()
            : ((e = ""),
        ...
        (goog.crypt.base64.decodeString = function (e, t) {
          var r;
          return goog.crypt.base64.HAS_NATIVE_DECODE_ && !t
            ? goog.global.atob(e)
            : ((r = ""),
        ...
        (jspb.utils.joinUnsignedDecimalString = function (e, t) {
          ...
          var n, o, i, a;
          return t <= 2097151
            ? "" + (jspb.BinaryConstants.TWO_TO_32 * t + e)
            : ((n =
                (16777215 & e) +
        ...
        (jspb.BinaryDecoder.prototype.readUnsignedVarint32 = function () {
          var e = this.bytes_,
            t = e[this.cursor_ + 0],
            r = 127 & t;
          if (t < 128) this.cursor_ += 1;
          else if (((r |= (127 & (t = e[this.cursor_ + 1])) << 7), t < 128))
            this.cursor_ += 2;
          else if (((r |= (127 & (t = e[this.cursor_ + 2])) << 14), t < 128))
            this.cursor_ += 3;
          else if (((r |= (127 & (t = e[this.cursor_ + 3])) << 21), t < 128))
            this.cursor_ += 4;
          else {
            if (((r |= (15 & (t = e[this.cursor_ + 4])) << 28), t < 128))
              return (
                (this.cursor_ += 5),
          ...
          return goog.asserts.assert(this.cursor_ <= this.end_), r;
        }),
        ...
        (jspb.BinaryDecoder.prototype.readBytes = function (e) {
          var t;
          return e < 0 || this.cursor_ + e > this.bytes_.length
            ? ((this.error_ = !0),
              goog.asserts.fail("Invalid byte length!"),
              new Uint8Array(0))
            : ((t = this.bytes_.subarray(this.cursor_, this.cursor_ + e)),
              (this.cursor_ += e),
              goog.asserts.assert(this.cursor_ <= this.end_),
              t);
        }),
    ...
    !function (e) {
      ...
      function n(e, t, r, n) {
        ...
        if (p.isEncoding((e = "string" == typeof e && "" !== e ? e : "utf8")))
          return (
            (t = 0 | f(n, e)),
            (o = (n = (o = l(o, t)).write(n, e)) !== t ? o.slice(0, n) : o)
          );
  ...
  yl30: function (g, A, O) {
      ...
      if (e)
        return (t = e._valueTracker)
          ? ((r = t.getValue()),
            (n = ""),
            (e = n =
              e ? (Je(e) ? (e.checked ? "true" : "false") : e.value) : n) !==
              r && (t.setValue(e), 1))
          : 1;
    }
    function et(e, t) {
    ...
    function qt(e, t, r, n, o) {
      return (
        null === e || e.nativeEvent !== o
          ? ((e = $t(t, r, n, o)), null !== t && null !== (t = kn(t)) && Rt(t))
    ...
    function Kt(e) {
      if (null === e.blockedOn) {
        var t,
          r = Xr(e.topLevelType, e.eventSystemFlags, e.nativeEvent);
        if (null === r) return 1;
        null !== (t = kn(r)) && Rt(t), (e.blockedOn = r);
      }
    }
    function Yt(e, t, r) {
      Kt(e) && r.delete(t);
      ...
      function a(e, t, r, n) {
        return (
          null !== t && t.elementType === r.type
            ? (((n = M(t, r.props)).ref = zi(0, t, r)), (n.return = e))
    ...
    function il(e) {
      ...
      return 0 !== t ||
        ...
        ((t = e.lastPingedTime), (e = e.nextKnownPendingLevel) < t)
        ? t
        : e;
    }
    function H(e) {
